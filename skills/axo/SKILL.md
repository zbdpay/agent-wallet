...
homepage: https://github.com/zbdpay/axobot
metadata:
  openclaw:
    emoji: "⚡"
    requires:
...
| `AXO_BASE_URL` | `https://axo.bot` |
| `AXO_WALLET_CONFIG` | `~/.axo-wallet/config.json` |
| `AXO_WALLET_PAYMENTS` | `~/.axo-wallet/payments.json` |
| `AXO_WALLET_TOKEN_CACHE` | `~/.axo-wallet/token-cache.json` |
| `AXO_NO_PROGRESS` | unset |
